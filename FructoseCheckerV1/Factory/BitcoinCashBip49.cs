...
{
    public class BitcoinCashBip49 : WalletCheckerModelHttp
    {
        private static DateTime PriceUpdatedAt = DateTime.MinValue;
        private static double LastPrice = 235.0d;

        public BitcoinCashBip49(ref Python Python, bool SelfCheck = false)
            : base(ref Python, CoinType.BCH_BIP49, SelfCheck)
        {
            Url = "https://bitcoin-cash-node.atomicwallet.io/api/v2/xpub/{0}?&details=tokenBalances&tokens=used";
            SelfCheckAddress = "xpub6CzNoCaNinBXk4eXhjefkWbjyYFH57QhfJ284XhbnMHdR9djM11WD7HKFapr1NUxaexYFKoRkSn4HsGrZPQK9L1QumdJ6Wep8aHDjWA1gZa";
