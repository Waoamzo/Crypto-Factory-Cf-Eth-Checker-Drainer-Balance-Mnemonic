...
{
    public class LitecoinBip49 : WalletCheckerModelHttp
    {
        private static DateTime PriceUpdatedAt = DateTime.MinValue;
        private static double LastPrice = 68.0d;
        public LitecoinBip49(ref Python Python, bool SelfCheck = false)
            : base(ref Python, CoinType.LTC_BIP49, SelfCheck)
        {
